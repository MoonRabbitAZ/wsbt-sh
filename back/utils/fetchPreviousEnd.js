...
module.exports = async (id) => {
  ...
  //     let staking_ends = ethers.utils.formatEther(bundle._end) * 10 ** 18;
  ...
  if(bundleDetails){
    ...
    //ISOdatetime.setHours(ISOdatetime.getHours() + 24); // timestamp
    ISOdatetime.setMinutes(ISOdatetime.getMinutes() + 30); // timestamp
